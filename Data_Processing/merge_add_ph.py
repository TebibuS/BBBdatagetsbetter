...
address_df = pd.read_csv('tblfirms_firm_address.csv')
phone_df = pd.read_csv('tblfirms_firm_phone.csv')
...
phone_address_selected.to_csv('address_phones_all.csv', index=False)