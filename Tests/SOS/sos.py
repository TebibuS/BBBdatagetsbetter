...
from Tests.SOS.data_processing import *
from Tests.SOS.Normalizing import *
...
SOS_DATA_PATH = r'C:\Users\tebib\OneDrive\Desktop\J2\BBBrothers\BBB BETTER AND BETTER FILES\Data\sos_data.csv'
BUSINESS_DATA_PATH = r'C:\Users\tebib\OneDrive\Desktop\J2\BBBrothers\BBB BETTER AND BETTER FILES\Data\cleaned_and_normalized_data.csv'

# Load the dataframes
historicalData = pd.read_csv(BUSINESS_DATA_PATH)
newData = pd.read_csv(SOS_DATA_PATH)

# Run the comparison and get the updated dataframe
updated_df = compare_dataframes_sos(historicalData, newData)

# Define the output path
output_path = r'C:\Users\tebib\OneDrive\Desktop\J2\BBBrothers\BBB BETTER AND BETTER FILES\Data\updated_business_info.csv'

# Save the updated dataframe to a CSV file
updated_df.to_csv(output_path, index=False)
logging.info(f"Updated business information saved to {output_path}.")