...
# Example address
address = '1408 County Road C West, Roseville, MN 55113'

# Normalize the address using the provided street type standardization dictionary
normalized_address = normalize_address(address, streetTypeStandardize)
